...
function handleSubmit(e){
    e.preventDefault();
if(!description){console.log('nodes',description)}else{
console.log("des valid")
  ...
  <Form onSubmit={handleSubmit}>
        ...
        <select value={lecturer} onChange={(e) => {
            
            
           console.log(e.target.value)
            setLecturer(e.target.value)}}>
          <option value="">Select Lecturer</option>
          <option value="bwanika">x</option>
          <option value="robert">y</option>
          <option value=" herbrt">h</option>
